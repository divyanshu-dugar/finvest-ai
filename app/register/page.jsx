...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center px-4 pt-16">
      <div className="absolute top-1/4 right-1/3 w-72 h-72 bg-violet-600/15 rounded-full blur-3xl pointer-events-none" />
      ...
      >
        <div className="bg-slate-900 border border-violet-400/20 rounded-2xl p-8 shadow-2xl shadow-violet-900/20">
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="w-12 h-12 rounded-xl bg-linear-to-br from-violet-500 to-indigo-600 flex items-center justify-center mb-3 shadow-lg shadow-violet-500/30">
              <Brain className="w-6 h-6 text-white" />
            </div>
            <h1 className="text-2xl font-bold text-white">Create account</h1>
            <p className="text-slate-400 text-sm mt-1">Start researching companies with AI</p>
          </div>
